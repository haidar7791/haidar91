...
const IMAGE_ASSETS = [
  ...
  require("./assets/images/Town_Hall_1.png"),
  ...
  require("./assets/images/Cobalt_warehouse_1.png"),
  require("./assets/images/Cobalt_warehouse_2.png"),
  require("./assets/images/Cobalt_warehouse_3.png"),
  require("./assets/images/Cobalt_warehouse_4.png"),
  require("./assets/images/Cobalt_warehouse_5.png"),
  require("./assets/images/Mercury_elixir_1.png"),
  require("./assets/images/Mercury_elixir_2.png"),
  require("./assets/images/Mercury_elixir_3.png"),
  require("./assets/images/Mercury_elixir_4.png"),
  require("./assets/images/Mercury_elixir_5.png"),
  require("./assets/images/Elixir_storehouse_1.png"),
  require("./assets/images/Elixir_storehouse_2.png"),
  require("./assets/images/Elixir_storehouse_3.png"),
  require("./assets/images/Elixir_storehouse_4.png"),
  require("./assets/images/Elixir_storehouse_5.png"),
  require("./assets/images/Laser_Tower_1.png"),
  require("./assets/images/Laser_Tower_2.png"),
  require("./assets/images/Laser_Tower_3.png"),
  require("./assets/images/Laser_Tower_4.png"),
  require("./assets/images/Laser_Tower_5.png"),
  require("./assets/images/cannon_1.png"),
  require("./assets/images/cannon_2.png"),
  require("./assets/images/cannon_3.png"),
  require("./assets/images/Forces_camp_1.png"),
  require("./assets/images/Forces_camp_2.png"),
  require("./assets/images/barracks_1.png"),
  require("./assets/images/barracks_2.png"),
  require("./assets/images/barracks_3.png"),
  require("./assets/images/building_hut.png"),
];
